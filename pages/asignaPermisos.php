...
<html> 
  <head> 
    <title>Administraci&oacute;n de Permisos</title> 
    ...
    <script src="../javascript/asignaPermisos.js" type="text/javascript"></script>
  </head> 
  <body>
        <?php echo $oAsignaPermisos->cargarAsignacionPermisos(); ?>
   </body> 
</html> 